...
Repo initialization:
    ...
    $ repo init -u https://github.com/AICP-Revived/platform_manifest.git -b q10.0
...
Example:
    ...
    git push ssh://USERNAME@gerrit.aicp-rom.com:29418/AICP/platform_manifest HEAD:refs/for/q10.0
...
please see [this link](https://github.com/AICP/vendor_aicp/blob/q10.0/docs/maintainerApplication.md) for further information and maintainer application.
